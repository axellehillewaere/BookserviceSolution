...
namespace Bookservice.WebAPI.Migrations
{
    ...
    [Migration("20181018094525_InitialCreate")]
            ...
            modelBuilder.Entity("Bookservice.WebAPI.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AuthorId = 1, FileName = "book1.jpg", ISBN = "123456789", NumberOfPages = 420, Title = "Learning C#" },
                        ...
                        new { Id = 4, AuthorId = 2, FileName = "book1.jpg", ISBN = "56789564", NumberOfPages = 360, Title = "Exploring ASP.Net Core 2.0" },
